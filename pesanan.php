...
<SCRIPT LANGUAGE="JavaScript">
  ...
  <!-- Akhir Navbar -->
		<div align="center"><strong><font size="6" face="Courier New, Courier, mono">DATA PESANAN</font></strong></div>
			<form name="form1" method="post" action="prosses.php">
				<table width="58%" border="0" align="center">
					...
					<tr>
						<td>Masukan pesanan anda</td>
						<td><input name="pesan" type="text" id="pesan"></td>
					</tr>
					<tr>
						<td>Hari pemesanan</td>
						<td><input name="hari" type="text" id="hari"></td> </tr>
					</tr>
						<td></td>
